...
__SINTHETA FUNCTION			;Essentially I am taking a value changing it into radians 
							;then using expansion of series to get the value and storing it in register
        VLDR.F32 S1,=90.0
        VMOV.F32 S0,S9
        VCMP.F32 S9,S1
		...
		VLDR.F32 S1,=360.0
        VSUB.F32 S0,S9,S1
LOOP    VLDR.F32 S7,=3.141592654 ;main code starts from here
		VLDR.F32 S8,=180.0
		VLDR.F32 S6,=1.0	;done to get 2n+1 term
		MOV R1,#20         			;20 iterartions
		VMUL.F32 S1,S0,S7
		VDIV.F32 S1,S1,S8					
		VMUL.F32 S2,S1,S1					
		VNEG.F32 S2,S2						
		VMOV.F32 S3,S1						
		VLDR.F32 S4,=2.0	;done to get 2n term 
		VMOV.F32 S5,S1		                
LOOP1	VMUL.F32 S3,S3,S2					;series for 20iterations
		VDIV.F32 S3,S3,S4					
		VADD.F32 S4,S4,S6					
		VDIV.F32 S3,S3,S4					
		VADD.F32 S4,S4,S6
...
;---------------------------------------------------------------------------------------------------------------------------------------------------
__COSTHETA FUNCTION	
LOOP2	VLDR.F32 S8,=3.141592654	;main code starts from here
		VLDR.F32 S7,=180.0	;radian conversion
		VLDR.F32 S6,=1.0	;2n-1 term
		MOV R1,#20         					;20 iterations
		VMUL.F32 S2,S9,S8	
		VDIV.F32 S2,S2,S7				
		VMUL.F32 S1,S2,S2				
		VNEG.F32 S1,S1				
		...
		VLDR.F32 S4,=1.0
		VMOV.F32 S5,S2		               
LOOP3	VMUL.F32 S3,S3,S1	;series starts from here				
		VDIV.F32 S3,S3,S4				
		VADD.F32 S4,S4,S6					
		VDIV.F32 S3,S3,S4				
		VADD.F32 S4,S4,S6					
